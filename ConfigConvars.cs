...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        // 战术暂停相关配置
        public FakeConVar<int> tacticalPauseDuration = new("matchzy_tactical_pause_duration", "Tactical pause duration in seconds. Default value: 30", 30);
        public FakeConVar<int> maxTacticalPausesAllowed = new("matchzy_max_tactical_pauses_allowed", "Max tactical pauses allowed per team. Default value: 3", 3);
